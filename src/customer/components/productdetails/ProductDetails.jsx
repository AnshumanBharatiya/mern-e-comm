  ...
  return (
    <div className="bg-white px-5 lg:px-20">
        <div className="pt-6">
            ...
            {/* product details */}
            <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 py-8'>
                {/* Image gallery */}
                <div className="flex flex-col items-center">
                    ...
                    <div className=" flex flex-wrap space-x-5 justify-center">
                        {product.images.map((item) =>  <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[4rem] max-h-[4rem] lg:max-w-[5rem]  lg:max-h-[5rem] mt-4">
                        <img
                            alt={item.alt}
                            src={item.src}
                            className="h-full w-full object-cover object-center"
                ...
                {/* Product info */}
                <div className="lg:col-span-1 max-w-auto max-w-2xl px-4 pb-14 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-14">
                    <div className="lg:col-span-2">
                        <h1 className="text-lg lg:text-xl font-semibold text-gray-900 ">Majestic Man</h1>
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div className="mt-6">
                            ...
                            <div className='flex items-center space-x-3'>
                                ...
                                <p className='text-sm opacity-50'>5640 Ratings</p>
                                <p className='ml-3 text-sm font-medium text-indigo-700 hover:text-indigo-400 cursor-pointer '>340 Reviews</p>
                            </div>
                        ...
                        <div className="mt-10">
                            ...
                            >
                                ...
                                <Radio
                                    ...
                                    'group relative flex items-center justify-center rounded-md border p-1 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none data-[focus]:ring-2 data-[focus]:ring-indigo-500 sm:flex-1 ',
                                    )}
                                >
                                    <span>{size.name}</span>
                                    {size.inStock ? (
                ...
                <div className='border p-5'>
                    <Grid container spacing={7}>
                        ...
                        <Grid item xs={5}>
                            ...
                            <div className='flex items-center space-x-3'>
                                <Rating value={3.5} precision={.5} readOnly />
                                <p className=' opacity-60'>5640 Ratings</p>
                            </div>
            ...
            <section className='pt-10'>
                <h1 className='font-bold text-xl py-5'>Similar Product</h1>
