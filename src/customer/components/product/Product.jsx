...
export default function Product() {
    ...
    const categoryValue = searchParamms.get("category");
    ...
    }, [param.lavelThree, colorValue, sizeValue, categoryValue, priceValue, discount, stock, sortValue, pageNumber]);
        ...
        <div className="bg-white">
            <div>
                ...
                <section aria-labelledby="products-heading" className="pb-24 pt-6">
                    ...
                    {/* Filters */}
                        <div>
                            <div className='flex justify-between items-center border-b border-gray-300 py-2 my-5'>
                                <h1 className='text-lg opacity-60 font-bold hidden lg:block'>Filters</h1>
                                <FilterListIcon className='hidden lg:block'/>
                            </div>
